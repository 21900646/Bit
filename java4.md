...
: 멀티스레드 코드를 구현하지 않아도 데이터를 투명하게 병렬로 처리 가능. <br>
-> 연속된 요소 <br>
- 컬렉션(주제: 데이터) : 시간과 공간의 복잡성과 관련된 요소 저장 및 접근 연산 <br>
- 스트림(주제: 계산) : filter, sorted, map처럼 표현 계산식.
<br><br>

-> 소스 <br>
: 데이터 제공 소스로부터 데이터를 소비. => 순서 유지됨. <br>

-> 데이터 처리 연산 <br>
: 함수형 프로그래밍 언어에서 지원하는 연산과 데이터베이스와 비슷한 연산. <br>
