...
public class Solution {
	...
	public static void main(String[] args) throws SQLException {
		...
		solution.rentalBookUser("user2", 5); //대출 추가
		solution.getUserInfo("user2");
	}
	...
	private void saveUserInfo(String userId, String userInfo) throws IOException {
		String path = String.format("D:\\lhy\\bipa_workspace\\SimpleLibrarySample\\data\\/%s.json",userId);
	...
	//대출 추가
	private void rentalBookUser(String userId, int bookSeq) throws SQLException {
		LibraryBookService service = new LibraryBookService();
		
		HashMap<String, String> returnMap = service.rentalBookByIdSeq(userId, bookSeq);
