...
**동작 파라미터란?**  <br>
- 아직은 어떻게 실행할 것인지 결정하지 않은 코드 블록. <br>
- 나중에 프로그램에서 호출. 즉 실행은 나중으로 미뤄진다. <br>
-> 변화하는 요구사항에 쉽게 적응하는 유용한 패턴임. <br><br>
...
메서드는 객체만 인수로 받기 때문에 test method를 ApplePredicate 객체로 싸서 전달해야함. <br><br>
